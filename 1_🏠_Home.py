...
st.warning("As of Streamlit v1.23 the experimental data editor changed to data editor. The output of this object has signifiganrly changed from previous version. This codebase has been updated to support v1.23+")
